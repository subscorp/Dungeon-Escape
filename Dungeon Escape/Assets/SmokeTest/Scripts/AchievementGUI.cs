...
namespace SmokeTest
{
    ...
    public class AchievementGUI : MonoBehaviour
    {
        ...
        internal void OnGUI()
        {
            ...
            {
                //DoAchievementReveal(GPGSIds.AchievementToReveal);
            }

            if (GUILayout.Button("Ach Reveal Incremental", GUILayout.Height(height), GUILayout.ExpandWidth(true)))
            {
                //DoAchievementReveal(GPGSIds.AchievementHiddenIncreamental);
            }
            ...
            {
                DoAchievementUnlock(GPGSIds.achievement_an_apple_a_day_keeps_the_doctor_away);
            }

            if (GUILayout.Button("Ach Increment", GUILayout.ExpandHeight(true)))
            {
                DoAchievementIncrement(GPGSIds.achievement_completionist); // Dungeon Escape
            }

            if (GUILayout.Button("Ach Increment Hidden", GUILayout.ExpandHeight(true)))
            {
                //DoAchievementIncrement(GPGSIds.AchievementHiddenIncreamental);
            }
        ...
        // Dungeon Escape Achievements
        internal void DoAchievementUnlock(string achivementId)
        {
        ...
        // End of Dungeon Escape Achievements
    }
}